      ...
      <Content>
        <QueryMenu className="Query" isFullscreen={isFullscreen} style={{
          ...
          <MenuBody shouldRotate={shouldRotate} pageDescription="Click on the circles to zoom into the process visualization.">
            <FilterType checkedValues={selectedActivities} updateSelectedValues={onInspectActivitiesChange} selectedValues={possibleActivities} label="Identify by Activity Type" />
            <IdentifyTaxonomy
