...
const id = "Filter-Actor-Type";

export default function FilterActorType({activityTypesChecks, updateActivityTypeChecks, typeValues}) {
    ...
    return(
        <Accordion className={Styles.card}>
            <AccordionSummary
                ...
                aria-controls="actor-type-filter-content"
                id="actor-type-filter-header"
            >
            <div>
                <h4><span className='key'>Filter by Actor Type:</span>
